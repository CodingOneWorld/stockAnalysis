...
def cal_hist_price_of_stock(code, latest_days=10000):
    ...
    # print(current_price)
    print([code, max_price, min_price, current_price])
    return [code, max_price, min_price, current_price]
...
def cal_price_pct(code, latestdays=3000):
    price = cal_hist_price_of_stock(code, latestdays)
    # print(price)
...
# 计算股票当前价格对最高价格的回撤幅度
def cal_price_withdraw_pct(code, latestdays=3000):
    price = cal_hist_price_of_stock(code, latestdays)
    # print(price)
